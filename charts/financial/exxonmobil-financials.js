const VERSION = "20260721-exxon-ui-v1";
...
const downloadChart = () => {
  ...
  link.download = `exxonmobil-${document.body.dataset.dashboard}.svg`;
  link.click();
...
window.addEventListener("resize", () => {
  if (window.__exxonMobilFinancialDebug?.payload) renderCurrent(window.__exxonMobilFinancialDebug.payload);
});
