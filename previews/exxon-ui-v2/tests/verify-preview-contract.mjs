...
assert.match(mapCss, /width:\s*clamp\(500px,\s*60%,\s*640px\)/);
...
assert.match(mapCss, /@container drawer \(max-width:\s*580px\)[\s\S]*?project-summary-grid/);
const summaryValueRule = mapCss.match(/\.summary-value\s*\{([\s\S]*?)\}/)?.[1] || "";
