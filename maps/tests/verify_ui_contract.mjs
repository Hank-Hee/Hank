...
assert.match(html, /<script type="module" src="app\.js\?v=20260701-global"><\/script>/);
...
assert.match(app, /from "\.\/app-core\.js\?v=20260701-global"/);
assert.match(app, /fetch\("operators\.json\?v=20260701-global"\)/);
assert.match(app, /fetch\("data\/country-centers\.json\?v=20260701-global"\)/);
