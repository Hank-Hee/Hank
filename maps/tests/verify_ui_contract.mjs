...
assert.match(html, /<script type="module" src="app\.js\?v=20260709-title-tooltip"><\/script>/);
...
assert.match(app, /from "\.\/app-core\.js\?v=20260709-title-tooltip"/);
assert.match(app, /fetch\("operators\.json\?v=20260709-title-tooltip"\)/);
assert.match(app, /fetch\("data\/country-centers\.json\?v=20260709-title-tooltip"\)/);
